    ...
    return `
        ...
        <html lang="en">
            <head>
                ...
                <title>Welcome to Realtime Chat</title>
                <style>
                    body {
            ...
            <body>
                ...
                <div style="background-color: white; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                    ...
                    <p>We're excited to have you join our messaging plataform! Messenger connects you with friends, family, and colleagues in real-time, no matter where they are</p>
                    ...
                    <p style="margin-bottom: 0;">Happy messaging!</p>
                ...
                <div style="text-align: center; padding: 20px; color: #999; font-size: 12px;">
                    ...
                    <p>
                        <a href="javascript:void(0)" style="color: #5B86E5; text-decoration: none; margin: 0 10px;">Privacy Policy</a>
                        <a href="javascript:void(0)" style="color: #5B86E5; text-decoration: none; margin: 0 10px;">Terms of Service</a>
                        <a href="javascript:void(0)" style="color: #5B86E5; text-decoration: none; margin: 0 10px;">Contact Us</a>
                    </p>
                </div>
            </body>
        </html>
